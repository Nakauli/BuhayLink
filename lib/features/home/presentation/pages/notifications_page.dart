...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  // --- NEW FUNCTION: Clear the Red Badge ---
  Future<void> _markAllAsRead() async {
    final uid = FirebaseAuth.instance.currentUser?.uid;
    if (uid == null) return;

    // 1. Get all unread notifications for this user
    ...
    // 2. Update them all at once (Batch)
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Dismissible(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          // Mark as read (redundant but good for instant feedback)
